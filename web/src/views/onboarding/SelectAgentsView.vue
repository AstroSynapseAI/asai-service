  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-4 text-center d-flex flex-column align-items-center">
        <div class="circle current mb-5"><h2 class="circle-text">3</h2></div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="lead">In order to dispatch emails yor email agent needs access to your preferd SMTP server.</p>
              </div>
            </div>
            ...
            <div class="row mt-1">
              <div class="col-10 offset-1">
                <p class="text-info fs-4">You can setup your email agent later. <a href="#" @click="skip">Skip for now</a></p>
              </div>
            </div>
          </div>
        </div>
