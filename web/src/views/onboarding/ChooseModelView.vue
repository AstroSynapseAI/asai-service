...
const next = () => {
  const onboardingData = JSON.parse(localStorage.getItem('onboarding_data'));
  onboardingData['openai_token'] = openAIToken.value;
  localStorage.setItem('onboarding_data', JSON.stringify(onboardingData));
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p class="lead">GPT family of models is provided via OpenAI API and is a paid service, to aquire your
                  API token plese visit OpenAI playground <a href="https://platform.openai.com"
            ...
            <div class="row">
              <div class="col-10 offset-1">
                ...
                <div class="form-floating mb-1">
                  <Field v-model="openAIToken" name="opnAIToken" type="text" class="form-control mb-2"
                    id="floatingInput" placeholder="Provide API Token..." />
            ...
            <div class="row mt-1">
              <div class="col-10 offset-1">
                <p class="text-info fs-4">You can provide this token later. <a href="#" @click="skip">Skip for now</a>
                </p>
              </div>
            </div>
